...
const templateMethodTxt = `// Code generated by "tools gen method"; DO NOT EDIT
...
func (gt *CmdGenMethod) genFuncName(fields []gen.TemplateModelField) string {
	str := ""
...
func (tgm *CmdGenMethod) joinFields(modelName string, fields []gen.TemplateModelField) string {
	rs := ""
...
func (tgm *CmdGenMethod) joinWhere(fields []gen.TemplateModelField) string {
	rs := ""
	for i, arg := range fields {
...
func (tgm *CmdGenMethod) joinConditions(fields []gen.TemplateModelField) string {
	rs := ""
	for i, arg := range fields {
		if i == 0 {
...
func (tgm *CmdGenMethod) parseMethodFuncsToTemplate(tp *template.Template, td TemplateDataMethodFunc, templateTxt string, templateName string) (err error) {
...
func (tgm *CmdGenMethod) ParseIndexToMethod() error {
	var err error
...
func (tm *CmdGenMethod) parseTagToTokens(s string) (rs []string, e error) {
	rs = make([]string, 0)
	tmp := bytes.Buffer{}
	keyS := false
	for i := 0; i < len(s); i++ {
...
func (tm *CmdGenMethod) parseDecsToIndex(decs dst.Decorations, fieldMap *map[string]gen.TemplateModelField) error {
...
func (tm *CmdGenMethod) ParseDstTree(file *dst.File) error {
...
func (tm *CmdGenMethod) ImportFile(filePath string) error {
...
func (tm *CmdGenMethod) parseTypesVar(v *gotypes.Var, tag string) []gen.TemplateModelField {
	if v.Embedded() {
		t := v.Type()
